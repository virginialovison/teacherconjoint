...
$featurearray = array("School social worker" => array("One social worker","No social worker"),"School counselor" => array("No counselor","One counselor per 250 kids","One counselor per 500 kids"),"School nurse" => array("One nurse","No nurse"),"In-class SPED support" => array("SPED-certified co-teacher","Paraprofessional"),"Instructional coach" => array("Each teacher assigned a coach","No coaches"),"Family & community liaison" => array("One liaison","No liaison"),"Salary" => array("Same as your current position","10% more than your current position"),"Class size" => array("15","20","25"),"Child care benefits" => array("None","District subsidizes child care costs"));
...
$attrconstraintarray = array(array("Salary","Class size","Child care benefits"),array("School social worker","School counselor","School nurse","Family & community liaison"),array("In-class SPED support","Instructional coach"));
